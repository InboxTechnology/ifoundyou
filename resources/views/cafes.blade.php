                            ...
                            @endif -->
                                ...
                                <?php //print_r($all); ?>
                                    ...
                                    <form method="post" action="{{url('/account')}}" >
                                        ...
                                        <input type="hidden" name="interested_in" value="{{$all['interested_in']}}">
                                        <input type="hidden" name="zip_code" value="{{$all['zip_code']}}">

                                        <div class="form-group cus-form-group states rel">
                                                            <label>Select Cafe</label>
                                                            <select style="width:100%;" class="form-control" name="cafe" id="cafe">
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('.search').click(function(e){
            var cafe = $('#cafe').find(":selected").val();
            if(cafe == ''){
                e.preventDefault();
