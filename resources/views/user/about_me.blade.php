...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<ul class="nav-inner">
		...
		<li class="active"><a href="javascript:;">About Me</a></li>

		@guest
          <li class="lii"><a href="{{url('/login')}}" class="ro">Sign in</a></li>
        @else
          <!-- <li class="lii"><a href="{{url('/logout')}}" class="ro">Sign out</a></li> -->
        @endguest
	</ul>

	<div class="edit-profile-tabs">
		<ul class="nav nav-tabs nv" role="tablist" style="display: none">
		  ...
		  <li class="al last-step-li" role="presentation"><a href="#tab10" role="tab" data-toggle="tab">Thank You</a></li>
		</ul>
		 
		<!-- Tab panes -->
		<form method="post" action="{{ url('/user/about-me') }}" id="profileForm" enctype="multipart/form-data">
			<div class="tab-content forms-in" id="profile-page">
				{{ csrf_field() }}
			  		...
			  		<div class="row">
				  		<div class="col-md-12">
				  			<ul class="list-unstyled list-inline">
				  				<li class="prev-step-li"><button type="button" class="btn cafe-submit -step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit -step" data-toggle="tab" href="#tab1">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab2">Next</button></li>
								<li class="last-step-li"><button type="button" class="btn cafe-submit last-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
				  		</div>
			  		</div>
			  	...
			  	<div role="tabpanel" class="tab-pane" id="tab2">
			  		<div class="row">
				  		<div class="col-md-12">
				  			<ul class="list-unstyled list-inline">
					  			<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab1">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab3">Next</button></li>
								<li class="last-step-li"><button type="button" class="btn cafe-submit last-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
						</div>
					</div>
				...
				<div role="tabpanel" class="tab-pane" id="tab3">
					<div class="row">
						<div class="col-md-12">
							<ul class="list-unstyled list-inline ">
								<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab2">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab4">Next</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit last-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
						</div>
					</div>
					<div class="col-md-12 px">
				...
				<div role="tabpanel" class="tab-pane" id="tab4">
					<div class="row">
						<div class="col-md-12">
							<ul class="list-unstyled list-inline ">
								<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab3">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab5">Next</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit last-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
						</div>
					</div>
				...
				<div role="tabpanel" class="tab-pane" id="tab5">
					<div class="row">
						<div class="col-md-12">
							<ul class="list-unstyled list-inline ">
								<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab4">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab6">Next</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit last-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
						</div>
					</div>
					<div class="col-md-12 px">
						...
						<div class="col-md-12 gen">
							<div class="col-md-4 col-sm-4 col-xs-12">
								...
								<div><input type="checkbox" id="bodytype_athlethic" name="bodytype" class="bodytype" @if(Auth::user()->bodytype == "Athletic") checked @endif  value="Athletic"> <label>Athletic </label></div>
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div><input type="checkbox" id="bodytype_slender" name="bodytype" class="bodytype" @if(Auth::user()->bodytype == "Slender") checked @endif  value="Slender"> <label>Slender </label for="bodytype_slender"></div>
				...
				<div role="tabpanel" class="tab-pane" id="tab6">
					<div class="row">
						<div class="col-md-12">
							<ul class="list-unstyled list-inline ">
								<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab5">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab7">Next</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit last-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
						</div>
					</div>
				...
				<div role="tabpanel" class="tab-pane" id="tab7">
					<div class="row">
						<div class="col-md-12">
							<ul class="list-unstyled list-inline">
								<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab6">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab8">Next</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit last-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
						</div>
					</div>
				...
				<div role="tabpanel" class="tab-pane" id="tab8">
					<div class="row">
						<div class="col-md-12">
							<ul class="list-unstyled list-inline">
								<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab7">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab9">Next</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit last-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
						</div>
					</div>
				...
				<div role="tabpanel" class="tab-pane" id="tab9">
					<div class="row">
						<div class="col-md-12">
							<ul class="list-unstyled list-inline">
								<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
								<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab8">Back</button></li>
								<li class="next-step-li"><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#tab10">Next</button></li>
								<li class=""><button type="button" class="btn cafe-submit past-step" data-toggle="tab" href="#tab10">Last</button></li>
							</ul>
						</div>
					</div>
				...
				<div role="tabpanel" class="tab-pane last-step-div" id="tab10">
					<div class="col-md-12" style="float: right;">
						<ul class="list-unstyled list-inline ri nx">
							<li class="prev-step-li"><button type="button" class="btn cafe-submit first-step" data-toggle="tab" href="#tab1">First</button></li>
							<li class="prev-step-li"><button type="button" class="btn cafe-submit prev-step" data-toggle="tab" href="#tab9">Back</button></li>
						</ul>
					</div>
					<div class="col-md-12 px">
						<div class="col-md-12 gen">	
