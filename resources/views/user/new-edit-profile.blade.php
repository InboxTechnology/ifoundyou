...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<ul class="nav-inner">
		...
		<li class="active"><a href="{{ url('/user/user-match-info')}}">Edit Profile</a></li>
	...
	<div class="col-md-12 all" style="text-align: center; clear: both;">
		<ul class="app-links">
		    <li class="about">
		    	<a href="{{ url('/user/new_user_aboutme') }}">
		    		<img class="img_size" src="{{ asset('public/img/about_me1.jpg') }}">
		    	</a>
		    </li>
		    ...
		    <li>
		    	<a  href="{{url('user/new_user_aboutmymatch')}}">
		    		<img class="about-match-img img_size" src="{{ asset('public/img/about_my_match1.jpg') }}">
		    	</a>
		    </li>

		    <li>
		    	<a href="{{url('user/login_horoscope')}}">
		    		<img class="img_size" src="{{ asset('public/img/horoscope1.jpg') }}">
		    	</a>
		    </li>

		    <li>
		        <a href="{{ url('user/mycafe') }}">
		          <img  class="img_size" src="{{ asset('public/img/MY-CAFE-300.png') }}">
		        </a>
		    </li>

		    <li>
		        <a href="{{ url('/user/user-profile') }}">
		          <img class="img_size" src="{{ asset('public/img/MY-PROFILE-300.png') }}">
		        </a>
		    </li>

		    <li>
		        <a href="{{ url('/user/change-photo') }}">
		          <img src="{{ asset('public/img/MY-PROFILE-PHOTO-300.png') }}">
		        </a>
		    </li>

		    <li>
		        <a href="{{ url('user/account-info') }}">
		          <img  class="img_size" src="{{ asset('public/img/my_account1.jpg') }}">
		        </a>
		    </li>

		    <li>
		        <a href="{{ url('user/dashboard') }}">
		          <img  class="img_size" src="{{ asset('public/img/home1.jpg') }}">
		        </a>
		    </li>
		</ul>
	</div>

	<div class="edit-profile-tabs ed" style="display: none;">
		<!-- Nav tabs -->
		<ul class="nav nav-tabs" role="tablist">
		  <li  class="active" role="presentation"><a href="#tab2" role="tab" data-toggle="tab">Looking to Date</a></li>
		  <li role="presentation"><a href="#tab3" role="tab" data-toggle="tab">About Me</a></li>
		  <li role="presentation"><a href="#tab4" role="tab" data-toggle="tab">About My Match</a></li>
		  <!-- <li role="presentation"><a href="#tab5" role="tab" data-toggle="tab">Location</a></li> -->
		  <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">My Interests</a></li>
		  <li role="presentation"><a href="#tab7" role="tab" data-toggle="tab">My Match Interests</a></li>
		  <li role="presentation"><a href="#tab8" role="tab" data-toggle="tab">Types of Relationship</a></li>
		  <li role="presentation"><a href="#tab9" role="tab" data-toggle="tab">Horoscope Sign</a></li>
		  <li role="presentation"><a href="#tab10" role="tab" data-toggle="tab">My Profile Photo</a></li>
		<!--   <li role="presentation"><a href="#tab10" role="tab" data-toggle="tab">Cafe Location</a></li> -->
		  <!-- <li role="presentation"><a href="#tab11" role="tab" data-toggle="tab">Thank You</a></li> -->
		</ul>
			...
			<div class="tab-content forms-in" id="profile-page">
				{{csrf_field()}}
			  	...
			  	<div role="tabpanel" class="tab-pane" id="tab3">
			  		...
			  		<?php /*<div class="col-md-5 col-sm-6 col-xs-12">
					...
					<div class="col-md-5 col-sm-6 col-xs-12">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-12 wid">
								<label>Month</label>
...
<!-- 
				...
				<div role="tabpanel" class="tab-pane" id="tab11">
					<div class="col-md-12">	
						<p style="text-align:center" class="thank-you-style">Thank you for filling out About Me page.</p>
					</div>
