...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<ul class="nav-inner">
		...
		<li class="active"><a href="javascript:;">About My Match</a></li>
	...
	<div class="edit-profile-tabs">
		...
		<!-- Tab panes -->
		<form method="post" action="{{ url('/user/about-my-match') }}" id="profileForm" enctype="multipart/form-data">
			{{ csrf_field() }}
					...
					<div class="col-md-12 px">
						...
						<div class="col-md-12 gen">
							...
							<div class="col-md-3 col-sm-3 col-xs-12">
								...
								<div><input type="checkbox" id="height_5.6" name="about_height[]" class="height" @if(in_array('5.6', $aboutHeights)) checked @endif value = "5.6"> <label for="height_5.6">5.6 </label></div>
							</div>
							<div class="col-md-3 col-sm-3 col-xs-12">
								...
								<div><input type="checkbox" height_5.9 name="about_height[]" class="about_height" @if(in_array('5.9', $aboutHeights)) checked @endif value = "5.9" > <label for="height_5.9">5.9 </label></div>
							</div>
					...
					<div class="col-md-12 px"><h4>Body Type</h4>
						<div class="col-md-12 gen">
							<div class="col-md-4 col-sm-4 col-xs-12">
								...
								<div><input type="checkbox" id="bodytype_athlethic" name="about_bodytype[]" class="about_bodytype" @if(in_array('Athletic', $aboutBodytypes)) checked @endif  value="Atheltic"> <label for="bodytype_athlethic">Athletic </label></div>
