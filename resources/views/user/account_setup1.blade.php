									...
									<div class="process">
										<div class="process-row nav nav-tabs">
											...
											<div class="process-step">
												<button type="button" class="btn btn-default btn-circle" data-toggle="tab" href="#looking_to_date">2</button>
												<p>Looking to Date</p>
											</div>
											<div class="process-step">
									...
									<div class="tab-content">
										...
										<div id="menu7" class="tab-pane fade">
											...
											<div class="col-md-5 col-sm-6 col-xs-12" style="margin-top: 6px;">
												...
												<input type="text" value="{{ Auth::user()->cafe }}" class="form-control" id="cafe-input" autocomplete="off" placeholder="Enter Zip Code">
											...
											<ul class="list-unstyled list-inline">
												...
												<li><button type="button" class="btn cafe-submit next-step" data-toggle="tab" href="#imageUpload"><i class="fa fa-check"></i> Next</button></li>
											</ul>
										</div>
											...
											<div class="account-section" id="change-photo">
												<div class="col-md-12">
													<div class="profile-box profile-box-1 image-editor">
														...
														<div class="row">
															<div class="col-sm-3 image-area cropit-preview">
																@if(Auth::user()->image)
																<img src='{{ url('public/img').'/'.Auth::user()->image }}'>
																@else
															...
															<div class="col-sm-6 col-sm-offset-1">
																...
																<div class="top-section">
																	<span style="display:none"><input type="file" class="cropit-image-input form-control" name="image" id="image"></span>
...
<script type="text/javascript">
   jQuery(document).ready(function() {
      ...
      jQuery('#cafe-input').keyup(function(event) {
      	var cafe = jQuery('#cafe-input').val();
      	if(cafe.trim()!='' && cafe.length>4){
	      	jQuery.ajax({
	      		type: "GET",
	      			...
	      			if(data) {
	      				...
	      				if(data.length>0){
	      					for (var i =0; i<data.length; i++) {
	      						location+=`<input type='radio' name='location' class='location' onclick="getVal('`+data[i].store_name+`','`+data[i].city+`','`+data[i].country+`','`+data[i].zip_code+`')" >`+data[i].zip_code+`<br />`;
	      					}
