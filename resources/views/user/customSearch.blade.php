...
@section('content')
	<style>
		...
		label{font-size: 17px;font-weight: 400;margin-bottom: 0px;color:#51656a;font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;padding: 0 !important;}
		#search-cafe-member{margin-top: 22px;}
	</style>
...
<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
	...
	<div class="cafe-form">
		<!-- <div class="no-records col-md-12" style="display: none;">No records found</div> -->
			<form method="get" action="{{ url('/user/customSearch') }}" id="cafe-members-form">
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-3 cl-appform">
								<input type="submit" value="Search" class="btn button-blue cafe-submit ipad" name="search-cafe-members" id="search-cafe-member" disabled>
							</div>
						</div>
						<div class="row">
