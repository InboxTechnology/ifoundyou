                            ...
                            <div class="right-userdetails">
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <ul>
                                        ...
                                        <li><span>Body Type:</span>@if($userDetail->bodytype == 'Atheltic') Athletic @else  {{ $userDetail->bodytype }} @endif</li>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <h4>{{ 'IFY-'.$userDetail->UserState->state_name.'-'.$userDetail->datepoint.'-'.str_pad($userDetail->id, 4, '0', STR_PAD_LEFT) }}</h4>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <ul>
                                            <li><span>Body Type:</span>@if($userDetail->about_bodytype == 'Atheltic') Athletic @else {{ $userDetail->about_bodytype }} @endif</li>
                                ...
                                <div class="col-md-12 col-dm-12">
                                    @if( $userDetail->UserCafe )
                                    <h3>My Cafe Location</h3> 
                                    <iframe
                                    width="100%"
                                    height="450"
                                    frameborder="0" style="border:0"
                                    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBGO8o4JyybRaVx409C2tNowstVKD42FFU&q={{ urlencode($userDetail->UserCafe->store_name.','.$userDetail->UserCafe->address_line_1.','.$userDetail->UserCity->city_name.','.$userDetail->UserState->state_name.','.$userDetail->UserCafe->zip_code) }}" allowfullscreen>
                                </iframe>
                                @endif
