        ...
        <div class="@if( Request::path() == 'advance-search-result' ) container-fluid @else container @endif header-area">
             <div class="row">
                <?php /*@if( 
                      ...
                      <div class="row">
                          ...
                          <?php /*@if( Request::path() != '/' &&  Request::path() != 'home')*/?>
                              <div class="col-lg-2 col-md-3 col-xs-12">
                                ...
                                <a href="{{url('/')}}">
                                    <img src="{{ asset('public/img/logo.png') }}" style="float:left;width: 234px;" class=" center-block logo-top">
                                </a>
                              ...
                              <div class="col-md-12 lo-in">
                                <h4>The Right One The Right Way</h4>
                              </div>
                          <?php /*@endif*/?>
                         <!--  @if(Request::path() == '/')
                  ...
                  <div class="col-md-12 bara">
                    <ul class="nav-inner mb-10">
                <li><a href="https://ifoundyou.com/">Home</a></li>
                <li class=""><a href="{{url('/')}}">State List</a></li>
                <li class=""><a href="{{url('/:').$statename}}">{{$statename}}</a></li>
                <li class=""><a href="{{url('/:').$statename}}">{{@$sesion['city']}}</a></li>
                <li class=""><a href="{{url('/').'/'.@$statename.'/'.@$sesion['city']}}">Type of Relationship</a></li>
                <li class=""><a href="{{url('/_').@$statename.'/'.@$sesion['city']}}">Birthday</a></li>
                <!-- <li class=""><a href="{{url('/DOB')}}">User Name</a></li> -->
                <li class="active disabled"><a href="">E-mail</a></li>
...
<div class="container-fluid pd-none bod">
    <div class="wrapper-cl ct-acct">
        <div class="container cont">
            ...
            <div class="row">
                <form  action="{{ route('register') }}" method="post" class="form-box" id="accountform" >
                <div class="col-md-12 gri">
                        ...
                        @endif
                        <div class="ct-form n-f" id="newmain">
                            <?php //print_r(@$sesion); ?>
                            ...
                            <?php //print_r(@$sesio); ?>                            
                                ...
                                <input type="hidden" name="cafe" value="{{@$cafe_loc}}">
                                <input type="hidden" name="day" value="{{@$sesion['day']}}">
                                <input type="hidden" name="month" value="{{@$sesion['month']}}">
                                <input type="hidden" name="year" value="{{@$sesion['year']}}">
                                <input type="hidden" name="name" value="{{@$sesion['name']}}">
