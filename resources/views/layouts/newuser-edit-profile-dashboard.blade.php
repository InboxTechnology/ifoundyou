            ...
            <div class="wrapper-cl">
                <div class="container-cl container co">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 full_dashboard fl">
                            <div class="profil-link col-md-12 col-lg-12 col-xs-12">
                                <div class="col-md-3 col-lg-3 col-xs-4">
                                    @if( Request::path() == 'thank-you' )
                                      <a href="{{ url('user/dashboard') }}" class="logo-dashboard logo-mob">
                                        <img src="{{ asset('public/img/logo.png') }}" style="float:left" class="img-responsive center-block logo-top mobile-logo">
                                      </a>
                                    @else
                        ...
                        <div class="container-fluid pd-none bg-main-content main-content-area @if(Request::path() == 'user/user-match-info') lg-i @elseif(Request::path()== 'user/new_user_aboutme') lg-i @elseif(Request::path() == 'user/new_user_aboutmymatch') lg-i  @elseif(Request::path() == 'user/horoscope')  lg-i @else lg-i @endif">
                          @yield('content')
                        </div>
